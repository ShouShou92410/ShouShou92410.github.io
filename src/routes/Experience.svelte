<section id="experience" class="flex flex-col w-full min-h-1/2 justify-center m-auto md:py-12 py-3">
	...
	<div class="md:pt-6 pt-3">
		...
		<div class="pt-5">
			<div class="pl-3">
				<p class="font-bold">Software Developer</p>
				<p class="italic lg:text-base md:text-sm text-xs">February 2023 - Present</p>
			</div>
		...
		<div class="pt-5">
			<div class="pl-3">
				<p class="font-bold">Associate Software Developer</p>
				<p class="italic lg:text-base md:text-sm text-xs">September 2021 - February 2023</p>
			</div>
			<div class="border-l-2 border-primary text-left ml-10">
				<ul class="list-disc pl-10 md:my-3 my-1">
					<li class="md:my-1 my-0.5">
		...
		<div class="pt-5">
			<div class="pl-3">
				<p class="font-bold">Software Intern (Part time)</p>
				<p class="italic lg:text-base md:text-sm text-xs">September 2020 - September 2021</p>
			</div>
			<div class="border-l-2 border-primary text-left ml-10">
				<ul class="list-disc pl-10 md:my-3 my-1">
					<li class="md:my-1 my-0.5">
		...
		<div class="pt-5">
			<div class="pl-3">
				<p class="font-bold">Software Intern</p>
				<p class="italic lg:text-base md:text-sm text-xs">June 2019 - August 2020</p>
			</div>
			<div class="border-l-2 border-primary text-left ml-10">
				<ul class="list-disc pl-10 md:my-3 my-1">
					<li class="md:my-1 my-0.5">
