...
<section id="about" class="flex flex-col w-2/3 min-h-1/2 justify-center m-auto py-12">
	...
	<p>
		...
		My programming journey began with me trying to modify the CSS styles of a now closed Taiwanese blog
		site, <a href="https://en.wikipedia.org/wiki/Wretch_(website)">無名小站</a>, and I've been in
		love with creating things using code ever since.
		<br />
