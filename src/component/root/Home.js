...
function Home() {
  return (
    <Jumbotron className="pt-0 pb-0 mt-3">
      <Row>
        ...
        <Col className="pt-3 pb-3">
          ...
          <h1>Sean Wen</h1>
          <p>
            I'm a software developer interested in web and game development. I've been programming since the age of 16, and have graduated from the
            University of Calgary as a computer science major. I love playing video games, being active, and explore the Calgary city with my friends!
          </p>
